...
namespace mth
{
  ...
  public:
    ...
    */
    ...
    /* Operator - for const redefinition function.
     * ARGUMENTS:
     *   - Vector to sub:
     *       const vec2 &val;
     * RETURNS:
    ...
    */
    ...
    /* Pseudoscalar vector multiplication function.
       * ARGUMENTS:
       *   - product vector:
       *       const vec2<Type> &Vec;
       * RETURNS:
       *   (Type) product result.
       */
    Type operator|( const vec2<Type>& Vec ) const
    {
      return X * Vec.Y - Y * Vec.X;
    } /* End of 'operator|' function */

    BOOL operator==( const vec2<Type>& Vec ) const
    {
